 ...
 */
jdouble Java_planets_position_util_RiseSet_planetRise(JNIEnv *env, jobject this,
    ...
    swe_set_ephe_path("/mnt/sdcard/Android/data/planets.position/files/ephemeris");
 ...
 * Output: Julian date as a double
 */
jdouble Java_planets_position_util_RiseSet_planetSet(JNIEnv *env, jobject this,
                                                     jdouble d_ut, jint p, jdoubleArray loc,
                                                     jdouble atpress, jdouble attemp) {
 ...
 */
jdoubleArray Java_planets_position_SkyPosition_planetPosData(JNIEnv *env,
                                                             jobject this, jdouble d_et,
                                                             jdouble d_ut, jint p, jdoubleArray loc,
                                                             jdouble atpress, jdouble attemp) {
    ...
    swe_set_ephe_path(
            "/mnt/sdcard/Android/data/planets.position/files/ephemeris");
...
jdoubleArray Java_planets_position_LivePositionService_planetLiveData(
        JNIEnv *env, jobject this, jdouble d_ut, jint p, jdoubleArray loc,
        jdouble atpress, jdouble attemp) {
 ...
 */
jdoubleArray Java_planets_position_WhatsUpTask_planetUpData(JNIEnv *env,
                                                            jobject this, jdouble d_et,
                                                            jdouble d_ut, jint p, jdoubleArray loc,
                                                            jdouble atpress, jdouble attemp) {
...
jdoubleArray Java_planets_position_solar_SolarEclipseTask_solarDataGlobal(
        JNIEnv *env, jobject this, jdouble d_ut, jint back) {
...
jdoubleArray Java_planets_position_solar_SolarEclipseTask_solarDataLocal(
        JNIEnv *env, jobject this, jdouble d_ut, jdoubleArray loc, jint back) {
...
jdoubleArray Java_planets_position_solar_SolarEclipseMap_solarMapPos(
        JNIEnv *env, jobject this, jdouble d_ut) {
...
jdoubleArray Java_planets_position_lunar_LunarOccultTask_lunarOccultGlobal(
        JNIEnv *env, jobject this, jdouble d_ut, jint p, jint back) {
...
jdoubleArray Java_planets_position_lunar_LunarOccultTask_lunarOccultLocal(
        JNIEnv *env, jobject this, jdouble d_ut, jdoubleArray loc, jint p,
        jint back) {
